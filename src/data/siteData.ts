...
export const personalInfo = {
  ...
  // bio: "Hi, I'm Bishal, a Software Engineer with 4+ years of experience designing and building scalable web applications across the full stack. I've shipped production systems serving thousands of users, led feature development from concept to deployment, and collaborated with cross-functional teams in fast-paced environments. My work spans frontend development with React and Next.js, backend APIs with Node.js and Express, cloud infrastructure on AWS, and applied AI including RAG-based chatbots, computer vision models, and cybersecurity research. Currently I am also exploring quantum computing through research and software development, applying two-timescale reinforcement learning to quantum network optimization. I care about writing clean, maintainable code and building products that make a real difference for users.",
  bio: "Hi, I'm Bishal, a Software Engineer with 4.5+ years of experience designing and building scalable web applications across the full stack. I've shipped production systems serving thousands of users, led feature development from concept to deployment, and collaborated with cross functional teams in fast paced environments. My work spans frontend development with React and Next.js, backend APIs with Node.js and Express, cloud infrastructure on AWS, and applied AI including RAG based chatbots, computer vision models, and cybersecurity research. I recently completed my M.S. in Computer Science at Tennessee Tech, where my research spanned two timescale reinforcement learning for quantum network optimization using real photon detector data, and Genetic Algorithm and Ant Colony Optimization approaches for electric vehicle charging station placement. I care about writing clean, maintainable code and building products that make a real difference for users.",
...
export const experience = [
  {
    ...
    companyLogo: ttuLogo,
    highlights: [
      "Implemented a two-timescale Q-learning system integrating real photon coincidence detector data to optimize Variational Quantum Eigensolver (VQE) performance across a quantum network, replacing simulated fidelity with live experimental measurements.",
      "Designed a dual-agent reinforcement learning architecture in which a slow agent controlled physical network parameters, including laser power and coincidence window, while a fast agent optimized VQE gradient descent.",
      "Achieved a ground-state energy error of 0.0003 Ha for the H2 molecule.",
      "Validated the learned policy against random control, achieving 2.6x better energy accuracy and an 85% reduction in shot cost, demonstrating improved computational resource efficiency.",
      "Developed and evaluated experiments using Python, Qiskit, reinforcement learning techniques, and Jupyter Notebook.",
    ],
  },
  {
    ...
    companyLogo: ttuLogo,
    highlights: [
      "Developed Genetic Algorithm and Ant Colony Optimization approaches for multi-criteria EV charging station location planning.",
      "Modeled infrastructure, traffic, road network, cost, and inter-station distance constraints to evaluate potential charging station locations.",
      "Built an LSTM model achieving 99% accuracy on drone data and an XGBoost model achieving 95.25% accuracy on power system data for the CEROC AI-Assisted Cybersecurity Competition.",
      "Won 1st place in the 2025 CEROC AI-Assisted Cybersecurity Competition.",
  ...
  },
  {
    ...
    highlights: [
      "Led the development of a multi-tenant restaurant management platform serving 100+ restaurants and 10,000+ users, covering order management with KOT, inventory management, digital QR menus, and table and space management.",
      "Built a real-time operational dashboard enabling restaurant owners to monitor live sales, inventory, orders, and reports across all locations.",
      "Reduced website load time by 3 seconds through lazy loading, database query optimization, and reduction of unnecessary API calls.",
      ...
      "Enabled seamless onboarding of new restaurant tenants and reduced deployment disruption by migrating and synchronizing MongoDB databases across distributed multi-tenant environments.",
      "Mentored interns and junior developers through technical guidance and code reviews, supporting stronger code quality and team collaboration.",
    ],
  },
  {
    ...
    highlights: [
      "Implemented a promotional offer system for a high-traffic e-commerce platform, supporting coupon codes, percentage discounts, and time-limited product promotions.",
      "Supported application workloads handling hundreds of concurrent orders during peak seasons.",
      "Integrated Google and Apple OAuth authentication to provide secure third-party sign-in capabilities.",
      "Contributed to the design, development, and delivery of full-stack features using Next.js, NestJS, MySQL, and Docker.",
    ],
  },
  {
    ...
    highlights: [
      "Optimized database performance using stored procedures, indexing, and SQL query tuning to improve efficiency and scalability.",
      "Strengthened database security through input validation and secure query practices, reducing SQL injection risks by 30%.",
    ],
  },
];
